...
{
    public partial class PanelSlider1 : MetroFramework.Controls.MetroUserControl
    {
        Form _owner = null;
        bool _loaded = false;
        ...
        public PanelSlider1(Form owner)
            : this()
        {
            this.Visible = false;
            ...
            this.Click += PanelSlider1_Click;
            

            ResizeForm();
        }

        void PanelSlider1_Click(object sender, EventArgs e)
        {
            swipe(false);
        }
        ...
        {                
            this.Visible = true;
            Transition _transition = new Transitions.Transition(new TransitionType_EaseInEaseOut(3000));
