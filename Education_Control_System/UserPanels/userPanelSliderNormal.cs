...
{
    public partial class userPanelSliderNormal : MetroFramework.Controls.MetroUserControl
    {
        Form _owner = null;
        bool _loaded = false;
        ...
        public userPanelSliderNormal()
        {
            InitializeComponent();
        }

        public userPanelSliderNormal(Form owner)
            : this()
        {
            this.Visible = false;
