...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2017 at 02:27 AM
...
('DSEF', 'Diploma in Software Engineering', '200000.00', '1 year', 45, 'KUMISF002');
...
('KUMISP003', 'Ravindi', 'Nanayakkara', 'F', '14/03/1991', 'No.33/1,Polgahawela', 711238892, NULL, 'MetroFramework.Controls.MetroTextBox');
...
('KUSTMAN', 'Ashoka', 'Abesekara', 'M', 'No.20,Yamthampalawa', 712222221, 'KUFO', 'Manager', NULL, 'ashoka112233');
...
('KUDSE171F001', 'Madhura', 'Nawarathne', 'DSEF', 'M', '18/07/1996', 'No.01,Kala Para,Thummulla', 712323434, 372232323, '2012', NULL, 'MetroFramework.Controls.MetroTextBox');
...
INSERT INTO `student_payment` (`StuID`, `PayID`, `PayDate`, `PayAmount`, `Remaining`, `PayMethod`) VALUES
('KUDSE171F001', '171F001', '11/10/2017', '100000.00', '100000.00', 'Cash');
...
CREATE TABLE `student_review` (
  `StuID` varchar(13) NOT NULL,
  `StuAtten` int(3) DEFAULT NULL,
  `StuDiscp` int(3) DEFAULT NULL,
  `StuKnow` int(3) DEFAULT NULL,
  `StuTutor` int(3) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `student_review` (`StuID`, `StuAtten`, `StuDiscp`, `StuKnow`, `StuTutor`) VALUES
('KUDCSD171F002', 82, 95, 95, 83),
('KUDSE171F001', 83, 79, 80, 78);
